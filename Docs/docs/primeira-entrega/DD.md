...
| descricaoMundo   | string [400] |  Breve descrição textual imersiva do mundo em que o jogador está, contando com ambiente e...     | A-Z   <br> </br> a-z             | Não                    | Não                  | -                 |
| nomeMundo        | string [50]|  Nome do mundo em questão                                                                         | A-Z <br> </br>a-z             | Não                    | Não                  | -                 |
...
| descricaoRegiao  | string [400]| Breve descrição textual imersiva da região em que o jogador está, contando com ambiente e atmosfera, interatividade e estilo.     | A-Z <br></br> a-z             | Não                    | Não                  | -                 |
...
| nomePersonagem   | string [50] | Nome do NPC em questão                                                                            | A-Z <br> </br>a-z             | Não                    | Não                  | -                 |
| Loot           | string [50] | Identificador de qual item está sendo dropado pelo NPC após sua morte                                   | A-Z <br> </br>a-z             | Sim                    | Sim. Chave estrangeira                  | Apenas um item deverá ser dropado              |
...
| nomePersonagem   | string [50] | Nome do PC em questão                                                                            | A-Z <br> </br>a-z             | Não                    | Não                  | -                 |
| status           | string [20] | Estado atual do personagem (ex: saudável, ferido, infectado).                                    | A-Z <br> </br>a-z             | Não                    | Não                  | -                 |
